...
sub1 = pd.read_csv('LSTM-submission2018_02_07 06_05_56_090909.csv')
...
sub2.to_csv('extraTreeClassifier_multiclass.csv')
'''
sub2 = pd.read_csv('extraTreeClassifier_multiclass.csv')
...
blend.to_csv('toxicAvenger' + timeStr + '.csv', index=False)
